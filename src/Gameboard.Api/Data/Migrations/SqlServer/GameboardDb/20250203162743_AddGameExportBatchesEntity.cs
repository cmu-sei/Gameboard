        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExportedByUserId = table.Column<string>(type: "nvarchar(40)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExportedInBatchesId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IncludedGamesId = table.Column<string>(type: "nvarchar(40)", nullable: false)
                },
                constraints: table =>
                {
