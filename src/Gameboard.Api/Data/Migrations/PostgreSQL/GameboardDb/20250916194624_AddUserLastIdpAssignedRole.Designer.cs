...
namespace Gameboard.Api.Data.Migrations.PostgreSQL.GameboardDb
{
    ...
    [Migration("20250916194624_AddUserLastIdpAssignedRole")]
    partial class AddUserLastIdpAssignedRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gameboard.Api.Data.PracticeChallengeGroup", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("TextSearchVector")
                        ...
                        .HasColumnType("tsvector")
                        .HasAnnotation("Npgsql:TsVectorConfig", "english")
                        .HasAnnotation("Npgsql:TsVectorProperties", new[] { "Name", "Id", "Description" });
            ...
            modelBuilder.Entity("Gameboard.Api.Data.Challenge", b =>
                {
                    ...
                    b.HasOne("Gameboard.Api.Data.ChallengeSpec", "Spec")
                        .WithMany("Challenges")
            ...
            modelBuilder.Entity("Gameboard.Api.Data.PracticeChallengeGroup", b =>
                {
                    b.HasOne("Gameboard.Api.Data.User", "CreatedByUser")
                        .WithMany("CreatedPracticeChallengeGroups")
                        .HasForeignKey("CreatedByUserId");

                    b.HasOne("Gameboard.Api.Data.PracticeChallengeGroup", "ParentGroup")
                        .WithMany("ChildGroups")
                        .HasForeignKey("ParentGroupId");

                    b.HasOne("Gameboard.Api.Data.User", "UpdatedByUser")
                        .WithMany("UpdatedPracticeChallengeGroups")
            ...
            modelBuilder.Entity("Gameboard.Api.Data.User", b =>
                {
                    ...
                    b.Navigation("CreatedPracticeChallengeGroups");
                    ...
                    b.Navigation("UpdatedPracticeChallengeGroups");
