...
{
    /// <inheritdoc />
    public partial class AddChallengeBonuses : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnteredById = table.Column<string>(type: "character varying(40)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ManualChallengeBonuses_Users_EnteredById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManualChallengeBonuses_EnteredById",
                table: "ManualChallengeBonuses",
                column: "EnteredById");
        }
