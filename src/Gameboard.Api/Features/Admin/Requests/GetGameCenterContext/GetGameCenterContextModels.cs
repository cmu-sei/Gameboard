...
public sealed class GameCenterContextStats
{
    ...
    public required int PlayerCountCompetitive { get; set; }
    public required int PlayerCountPractice { get; set; }
    public required int PlayerCountTotal { get; set; }
    public required int TeamCountActive { get; set; }
    public required int TeamCountCompetitive { get; set; }
    public required int TeamCountComplete { get; set; }
    public required int TeamCountPractice { get; set; }
