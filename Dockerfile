...
#
FROM mcr.microsoft.com/dotnet/sdk:8.0.303-jammy AS dev
...
#
FROM mcr.microsoft.com/dotnet/aspnet:8.0.7-jammy AS prod
...
RUN wget -O ~/wkhtmltopdf.deb https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6.1-2/wkhtmltox_0.12.6.1-2.jammy_arm64.deb
